...
impl ChainManager {
    ...
    pub fn check_reward_to_collateral_filter(&self, dr_state: &DataRequestState) -> bool {
        let dr_reward_to_collateral_ratio =
            (dr_state.data_request.witness_reward as f64 / dr_state.data_request.collateral as f64) * 1000.0;
        dr_reward_to_collateral_ratio > self.minimum_reward_to_collateral_ratio as f64
    }
