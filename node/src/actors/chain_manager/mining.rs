...
use witnet_data_structures::{
    chain::{
        ...
        EpochConstants, Hash, Hashable, OwnUnspentOutputsPool, PublicKeyHash, ReputationEngine,
        SuperBlock, TransactionsPool, UnspentOutputsPool, ValueTransferOutput,
    },
...
fn build_superblock(
    ...
    Some(SuperBlock {
        ...
        last_block_in_previous_superblock: previous_hash,
    })
}
